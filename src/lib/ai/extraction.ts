...
- chargedSections: the section(s) charged, e.g. "IPC 325", "BNS 117(2)", "NDPS 21(b)", "ARMS 25(1B)(a)" (Arms Act, 1959) or "TNPA 4(1)(a)" (Tamil Nadu Prohibition Act, 1937), comma-separated if multiple. Always use this "LAW NUMBER" shape — e.g. "Section 21 of the Narcotic Drugs and Psychotropic Substances Act" must be written as "NDPS 21", not spelled out. Include a clause letter only when the document states it.
